...
////////////////////////////////////// renders methods
  render(){
    ...
    {
      Session.set("waitBackURL","/addstaff");
      return(
        <Redirect to={"/wait"}/>
      )
    }
        ...
        <div className="row">
                    ...
                    :
                        <div className="card card-signup">
                            <h2 className="card-title text-center">Add New Staff Member</h2>
                            <div className="row">
...
onSubmit(e){
  ...
  Meteor.call("createStaff",staff,(err,result)=>{
    instance.setState({waiting:false});
    if(err){
      window.notify("danger", err.reason);
      return;
    }
      window.notify("success", "Staff Memeber successfully Created");
