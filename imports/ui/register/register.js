...
/////////////////////////////////////// lifecycle functions
  ...
  componentWillMount(){
    ...
    instance.TestTracker = Tracker.autorun(()=> {
      ...
      const heartbeatSensors=HeartbeatSensor.find({},{id:1}).fetch();
...
////////////////////////////////////// renders methods
  render(){
    ...
    {
      Session.set("waitBackURL","/register");
      return(
        <Redirect to={"/wait"}/>
      )
    }
                                ...
                                <div className="col-md-12">
                                  ...
                                  <form id="loginForm" onSubmit={this.onSubmit.bind(this)}>
                                      ...
                                      <div className="footer text-center">
                                        <button type="submit" id="registerFormSubmitButton" className="btn  btn-lg btn-success" >Register</button>
                                      </div>
                                  </form>
                                </div>
                            </div>
